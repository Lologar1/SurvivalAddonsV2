...
public class customEnchantmentsWrapper {
    ...
    public static String[] rareEnchantments = new String[]{"netheritestomp", "ftts", "sorcery", "reflect"};
    public static String[] epicEnchantments = new String[]{"lifesteal", "billionaire", "parasite", "rush"};
    public static String[] legendaryEnchantments = new String[]{"glasscannon", "critical", "smelt", "replenish"}; //add smelt

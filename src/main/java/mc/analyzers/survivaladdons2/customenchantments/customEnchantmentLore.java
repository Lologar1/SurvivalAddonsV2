    ...
    public static ArrayList<String> getThelore(String enchantment, int level) {
        ...
        switch (enchantment){
            ...
            case "smelt":
                ...
                break;
            case "rush":
                thelore.add(ChatColor.GRAY + "Literally go " + level*4 + "% faster!");
                break;
            case "reflect":
                thelore.add(ChatColor.GRAY + "Damage taken " + ChatColor.GREEN + "reflects " + ChatColor.GRAY + "an additional " + level*25 + "%" + " of health");
                thelore.add(ChatColor.GRAY + "removed into " + ChatColor.GOLD + "absorbtion" + ChatColor.GRAY + ", if you don't have absorbtion already");
                thelore.add(net.md_5.bungee.api.ChatColor.of("#7E716B") + "//Made with love and tears from java.lang.reflect");
                break;
            case "replenish":
                thelore.add(ChatColor.GRAY + "Breaking crops instantly replace them, buying one");
                thelore.add(ChatColor.GRAY + "seed crop for market price off the /shop");
                break;
        }
        return thelore;
    }

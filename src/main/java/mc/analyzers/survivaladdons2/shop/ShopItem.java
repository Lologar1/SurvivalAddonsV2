...
public class ShopItem {
    ...
    public static ShopItem getByMaterial(ItemStack type){
        ...
        try{
            ...
            System.out.println("No such ShopItem! " + id);
            return null;
        }
    }
    public static ShopItem getByMaterial(Material type){
        try{
            return (ShopItem) ShopItems.class.getField(type.name().toLowerCase(Locale.ROOT)).get(ShopItems.class);
        }catch (Exception e){
            System.out.println("No such ShopItem! " + type.name());
            return null;
        }
    }

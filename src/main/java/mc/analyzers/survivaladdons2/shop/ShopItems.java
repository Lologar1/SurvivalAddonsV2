...
public class ShopItems {
    public static final ShopItem iron_ingot = new ShopItem(new ItemStack(Material.IRON_INGOT), 32, 10, true, "mining");
    public static final ShopItem lapis_lazuli = new ShopItem(new ItemStack(Material.LAPIS_LAZULI), 32, 4, true, "mining");
    public static final ShopItem gold_ingot = new ShopItem(new ItemStack(Material.GOLD_INGOT), 32, 6, true, "mining");
    public static final ShopItem diamond = new ShopItem(new ItemStack(Material.DIAMOND), 32, 35, true, "mining");
    ...
    public static final ShopItem coal = new ShopItem(new ItemStack(Material.COAL), 32, 2, true, "mining");
    ...
    public static final ShopItem emerald = new ShopItem(new ItemStack(Material.EMERALD), 32, 5, true, "mining");
    ...
    public static final ShopItem ghast_tear = new ShopItem(new ItemStack(Material.GHAST_TEAR), 32, 5, true, "mob");
    public static final ShopItem quartz = new ShopItem(new ItemStack(Material.QUARTZ),32, 3, true, "mining");
    public static final ShopItem ender_pearl = new ShopItem(new ItemStack(Material.ENDER_PEARL), 32, 5, true, "mob");
    public static final ShopItem slime_ball = new ShopItem(new ItemStack(Material.SLIME_BALL), 32, 6, true, "mob");
    ...
    public static final ShopItem oak_log = new ShopItem(new ItemStack(Material.OAK_LOG), 32, 3, true, "blocks");
    public static final ShopItem acacia_log = new ShopItem(new ItemStack(Material.ACACIA_LOG), 32, 3, true, "blocks");
    public static final ShopItem dark_oak_log = new ShopItem(new ItemStack(Material.DARK_OAK_LOG), 32, 3, true, "blocks");
    public static final ShopItem jungle_log = new ShopItem(new ItemStack(Material.JUNGLE_LOG), 32, 3, true, "blocks");
    public static final ShopItem mangrove_log = new ShopItem(new ItemStack(Material.MANGROVE_LOG), 32, 3, true, "blocks");
    public static final ShopItem spruce_log = new ShopItem(new ItemStack(Material.SPRUCE_LOG), 32, 3, true, "blocks");
    public static final ShopItem birch_log = new ShopItem(new ItemStack(Material.BIRCH_LOG), 32, 3, true, "blocks");
    ...
    public static final ShopItem funky_feather = new ShopItem(item("funky_feather"), 32, 80, true, "other");
    ...
    public static final ShopItem repair_kit = new ShopItem(item("repair_kit"), 8, 10, true, "other");
    ...
    public static final ShopItem cactus = new ShopItem(new ItemStack(Material.CACTUS), 32, 2, true, "farming");
    public static final ShopItem wheat_seeds = new ShopItem(new ItemStack(Material.WHEAT_SEEDS), 180, 2, true, "farming");
    public static final ShopItem pumpkin_seeds = new ShopItem(new ItemStack(Material.PUMPKIN_SEEDS), 180, 2, true, "farming");
    public static final ShopItem melon_seeds = new ShopItem(new ItemStack(Material.MELON_SEEDS), 180, 2, true, "farming");
    public static final ShopItem beetroot_seeds = new ShopItem(new ItemStack(Material.BEETROOT_SEEDS), 180, 2, true, "farming");

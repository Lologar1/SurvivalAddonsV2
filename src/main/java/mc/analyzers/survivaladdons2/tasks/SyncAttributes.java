...
public class SyncAttributes extends BukkitRunnable {
    ...
    public SyncAttributes(Player player, SurvivalAddons2 plugin){
        ...
        materialAttributes.put(Material.NETHERITE_HELMET, "defense/125 health/1 magicdefense/65");
        //CHESTPLATES
        ...
        materialAttributes.put(Material.NETHERITE_CHESTPLATE, "defense/330 health/1 magicdefense/160");
        //LEGGINGS
        ...
        materialAttributes.put(Material.NETHERITE_LEGGINGS, "defense/245 health/1 magicdefense/140");
        //BOOTS
        ...
        materialAttributes.put(Material.NETHERITE_BOOTS, "defense/125 health/1 magicdefense/70");
        //RANGED
    ...
    public void run() {
        for(ItemStack item : player.getInventory().getContents()){
            ...
            if(item != null && item.getType().equals(Material.SHIELD)){
                item.setAmount(0);
                player.sendMessage(ChatColor.RED + "Shields are disabled !!!! BRUH!!");
            }
        }
        //Nightvision enchant

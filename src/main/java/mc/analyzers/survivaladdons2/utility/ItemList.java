...
public class ItemList {
    public static ItemStack item(String id){
        ...
        ItemStack sussy_berry = itemStackBuilder(ChatColor.YELLOW + "Suspicious Berries", "doNotInteract/true", 1, Material.SWEET_BERRIES, new String[]{ChatColor.YELLOW + "Potion ingredient", ChatColor.GRAY + "Very suspicious..."});
        ...
        ItemStack investor_firework = itemStackBuilder(ChatColor.WHITE + "Investor's Firework", "id/investor_firework doNotInteract/true", 1, Material.FIREWORK_ROCKET, new String[]{ChatColor.GRAY + "Use of this firework does not consume it", ChatColor.GRAY + "but instead buys one off the shop for market value"});
        ItemStack theitem = null;

        switch (id){
            case "investor_firework":
                theitem = investor_firework;
                break;

...
public class ItemList {
    public static ItemStack item(String id){
        ...
        ItemStack investor_firework = itemStackBuilder(ChatColor.WHITE + "Investor's Firework", "id/investor_firework", 1, Material.FIREWORK_ROCKET, new String[]{ChatColor.GRAY + "Use of this firework does not consume it", ChatColor.GRAY + "but instead buys one off the shop for", ChatColor.GRAY + "current price + 1"});
